...
type PromoPayload struct {
	...
	BookingHour   string         `json:"booking_hour" merge:"booking_hour" valid:"required"` // eg: 08.00-23.00
	Quota         int            `json:"quota" merge:"quota" valid:"required"`
	DailyMaxQuota int            `json:"daily_quota" merge:"daily_max_quota" valid:"required"`
...
type CreatePromoPayload struct {
	...
	BookingHour   string         `json:"booking_hour" merge:"booking_hour"`
	Quota         int            `json:"quota" merge:"quota"`
	DailyMaxQuota int            `json:"daily_max_quota" merge:"daily_max_quota"`
